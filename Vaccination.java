/* Q:1.Create abstract class vaccine.
 * Create two variables age(int),nationality(String).
 ...
 * Use flow control(If else) to check condition]
 */
package ANP_D0453;
// Abstract Class
abstract class Vaccine {
	...
	public void firstDose() {
		if (age >= 18 && nationality.equalsIgnoreCase("Indian")) {
			System.out.println("First dose completed successfully. Please pay Rs. 250.");
			System.out.println("------------------------------------------------------");
		} else {
...
First dose completed successfully. Please pay Rs. 250.
------------------------------------------------------
