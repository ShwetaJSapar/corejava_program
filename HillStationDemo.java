/* Q: Create one superclass HillStations and three subclasses Manali, Mussoorie, Gulmarg. 
...
class Mussoorie extends HillStation {
	...
	@Override
	public void famousFor() {
		System.out.println("Mussoorie is famous for its colonial heritage and the Mall Road.");
	}
}
...
class Gulmarg extends HillStation {
	...
	@Override
	public void famousFor() {
		System.out.println("Gulmarg is famous for its ski resorts and the Gulmarg Gondola.");
	}
}
...
Mussoorie is famous for its colonial heritage and the Mall Road.
Gulmarg is located in Jammu and Kashmir.
Gulmarg is famous for its ski resorts and the Gulmarg Gondola.
----------------------------------------------------------------
